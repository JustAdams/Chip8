...
## About
Chip 8 is a simple virtual machine which can read and execute .ch8 programs. You should be able to load any normal Chip8 ROM and play it using this implementation.
